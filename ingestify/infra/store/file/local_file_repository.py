...
class LocalFileRepository(FileRepository):
    ...
    def save_content(self, bucket: str, dataset: Dataset, version_id: int, filename: str, stream: IO[AnyStr]):
    ...
    def _get_path(self, bucket: str, dataset: Dataset, version_id: int, filename: str) -> Path:
        return self.base_dir / bucket / Path(dataset.dataset_id) / str(version_id) / filename
